...
char *_errordesc( unsigned int nErr ){
   ...
   switch( nErr ) {
      ...
      case 0x0028: pRet="A hozz†f˚zÇsi z†rol†s sikertelen";       break;
      case 0x0029: pRet="A z†rol†s sikertelen";                   break;
      case 0x002D: pRet="Z†rol†si hiba";                          break;
      case 0x002E: pRet="Z†rol†si idãt£llÇpÇs";                   break;
      ...
      case 0x029B: pRet="KiÇrtÇkelã verem (Eval stack) hiba";     break;
      ...
      case 0x270F: pRet="Belsã hiba";                             break;
