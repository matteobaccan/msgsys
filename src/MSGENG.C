...
char *_day_name( int nDay ){
   ...
   switch( nDay ){
      case  1: pRet = "Sunday";      break;
      case  2: pRet = "Monday";      break;
      case  3: pRet = "Tuesday";     break;
      case  4: pRet = "Wednesday";   break;
      case  5: pRet = "Thursday";    break;
      case  6: pRet = "Friday";      break;
      case  7: pRet = "Saturday";    break;
   }
...
char *_month_name( int nMonth ){
   ...
   switch( nMonth ){
      case  1: pRet = "January";     break;
      case  2: pRet = "February";    break;
      case  3: pRet = "March";       break;
      case  4: pRet = "April";       break;
      case  5: pRet = "May";         break;
      case  6: pRet = "June";        break;
      case  7: pRet = "July";        break;
      case  8: pRet = "August";      break;
      case  9: pRet = "September";   break;
      case 10: pRet = "October";     break;
...
CLIPPER NATIONMSG(){
   ...
   if( _parinfo(1)==NUMERIC ){
      switch (_parni(1)){
         case  1: pRet="Database Files    # Records    Last Update     Size"; break;
         case  2: pRet="Do you want more samples?";   break;
         case  3: pRet="Page No.";                    break;
         case  4: pRet="** Subtotal **";              break;
         case  5: pRet="* Subsubtotal *";             break;
         case  6: pRet="*** Total ***";               break;
         case  7: pRet="Ins";                         break;
         case  8: pRet="   ";                         break;
         case  9: pRet="Invalid date";                break;
         case 10: pRet="Range: ";                     break;
         case 11: pRet=" - ";                         break;
